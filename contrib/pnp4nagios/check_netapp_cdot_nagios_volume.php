...
$def[1] .= "CDEF:snapsizepct=snapsize,datatotal,/,100,* ";
...
$def[1] .= "GPRINT:snapsizepct:LAST:\"(%6.2lf%% of the volume)\\n\" ";

$def[1] .= "COMMENT:\" \\n\" ";
$def[1] .= "GPRINT:dataused:LAST:\"Data used space incl. snapshot over resv.\: %6.2lf%S\" ";
